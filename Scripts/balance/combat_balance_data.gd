...
@export var enemy_profiles: Dictionary = {
	&"crawler": {"max_health": 36.0, "move_speed": 88.0, "contact_damage": 10.0, "knockback_resistance": 0.0},
	&"spitter": {"max_health": 54.0, "move_speed": 78.0, "projectile_speed": 201.6, "knockback_resistance": 0.05},
...
@export var spawn_profile: Dictionary = {
	...
	"spawn_interval": 0.68,
	"minimum_spawn_interval": 0.32,
	"maximum_enemies": 36,
	"maximum_enemies_end": 82,
	"rush_enemy_budget_bonus": 36,
	"minimum_player_distance": 610.0,
	"spawn_clearance_radius": 46.0,
	"occupied_clearance_radius": 66.0,
	"maximum_spitter_ratio": 0.26,
	"maximum_charger_ratio": 0.20,
	"threat_costs": {
		"crawler": 1.0,
		"spitter": 2.3,
		"charger": 3.4,
